...
export default function HomePage() {
  ...
  return (
    <div className="relative h-auto w-full overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(255,177,102,0.22),transparent_35%),radial-gradient(circle_at_bottom_right,_rgba(124,198,255,0.18),transparent_30%),#f7efe2] font-mono text-[#1a2420]">
      <div
